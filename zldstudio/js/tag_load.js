function tag_load()
{
    var portfolio = site_settings.site_portfolio;
    ...
    if(tag_animation_color === "")
    {
        tag_animation_color = "black"
    }

    if(tag_animation_opacity === "")
    {
    ...
    if(portfolio == true)
    {
        // document.getElementById("section_portfolio").insertAdjacentHTML('afterbegin', `
        //         <tags id="section_tags" class="tags"></tags> 
        // `);
    }
